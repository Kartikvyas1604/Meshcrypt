...
```bash
# Build image
docker build -t meshcrypt/bridge-watcher .

# Run container
docker run -p 8080:8080 --env-file .env meshcrypt/bridge-watcher
```
...
- Documentation: https://docs.meshcrypt.io
